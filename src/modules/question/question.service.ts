...
> {
    ...
    async createQuestion(
        ...
        if (permission.granted) {
            ...
            const [user, _tags] = await Promise.all([
                ...
                this.tagQuestionRepository.findManyAndCreateIfNotExisted(
    ...
    async updateQuestionById(
        ...
        if (permission.granted) {
            ...
            if (data.tags)
                question.tags = await this.tagQuestionRepository.findManyAndCreateIfNotExisted(
