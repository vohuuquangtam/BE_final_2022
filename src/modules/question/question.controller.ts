...
export class QuestionController {
    ...
    @ApiOperation({
        ...
        description: 'Return a page of questions',
    })
    ...
    ): Promise<IPagination<IQuestionRO>> {
        return this.questionService.getAllQuestions(
            { ...pagOpts, route: `${apiUrl}/questions` },
            jwtUser,
        );
    }
    ...
    @ApiOperation({
        ...
        description: 'Return a question created',
    })
    ...
    @Auth()
    @ApiOperation({
        summary: 'Get a question by :questionId',
        description: 'Return a question with :id',
    })
    @ApiResponse({ type: QuestionRO, status: 200 })
    @Get('question/:id')
    getQuestionById(
    ...
    @ApiOperation({
        ...
        description: 'Return a question updated',
    })
    @ApiResponse({ type: QuestionRO, status: 201 })
    @Patch('question/:id')
    updateQuestion(
    ...
    @ApiOperation({
        ...
        description: 'Return a question delete message',
    })
